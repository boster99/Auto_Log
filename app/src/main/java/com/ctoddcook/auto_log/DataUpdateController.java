 ...
 *   <li>Implement the <code>DataUpdateController.DataUpdateListener</code> interface</li>
...
public class DataUpdateController {
  private static DataUpdateController sSingleton;
   ...
   */
  public synchronized static DataUpdateController getInstance() {
    if (sSingleton == null) {
      sSingleton = new DataUpdateController();
    }
    return sSingleton;
  }
