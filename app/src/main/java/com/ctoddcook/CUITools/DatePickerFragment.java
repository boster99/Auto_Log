 ...
 * value. Usage:
 * <ul>
 * <li>The calling activity must implement the <code>DatePickerFragment.DatePickerCaller</code> interface.
 * <li>The calling activity must use <code>DatePickerFragment.newInstance()</code> to create a dialog
 * instance.
 * </ul>
 *
